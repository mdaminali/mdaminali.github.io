...
!(function (s, t, e, o) {
	...
	function p(t, e) {
		;((this.element = s(t)), (this.settings = s.extend({}, m, e)), (this._defaults = m), (this._name = h), this.init())
	}
	function w(t) {
		if (g) {
			t.element.addClass("navbar-hidden").animate({ top: -1 * parseInt(t.element.css("height"), 10) + t.settings.navbarOffset }, { queue: !1, duration: t.settings.animationDuration })
			try {
	...
	function O(t) {
		g || (t.element.removeClass("navbar-hidden").animate({ top: 0 }, { queue: !1, duration: t.settings.animationDuration }), (g = !0), t.element.trigger("show.autoHidingNavbar"))
	}
	function b(t) {
		t.settings.disableAutohide ||
			((f = new Date().getTime()),
			(function (t) {
				var e = a.scrollTop(),
					i = e - d
	...
	;((p.prototype = {
		init: function () {
			...
			return (
				...
				(n = "auto" === this.settings.hideOffset ? parseInt(this.element.css("height"), 10) : this.settings.hideOffset),
				(t = this),
				r.on("scroll." + h, function () {
					new Date().getTime() - f > l
						? b(t)
						: (clearTimeout(i),
		...
		destroy: function () {
			return (r.off("." + h), a.off("." + h), O(this), s.data(this, "plugin_" + h, null), this.element)
		},
	}),
		(s.fn[h] = function (e) {
			var i,
			...
			return e === o || "object" == typeof e
				? this.each(function () {
						s.data(this, "plugin_" + h) || s.data(this, "plugin_" + h, new p(this, e))
					})
...
//         // Clear the form.
//         $("#contact-form .input-box input,#contact-form textarea").val("");
//       })
//       .fail(function(data) {
...
$("#contact-form").on("submit", function (e) {
	...
	$.ajax({
		...
		.done(function () {
			formMessages.removeClass("error").addClass("success").text("Thanks! Your message has been sent successfully.")
			form.trigger("reset")
		})
		.fail(function () {
			formMessages.removeClass("success").addClass("error").text("Oops! There was a problem sending your message.")
		})
})
...
!(function (t, e) {
	...
	return (
		...
		f &&
			(function (t, e) {
				if (e)
					if (e.length) for (var n, r = 0; (n = e[r]); r += 1) u(t, n)
					else u(t, e)
